...
def get_most_common_domains(emails, common_domains=None):
    ...
    filtered_emails = [domain for email in emails if (
        domain := email.split("@")[1]) not in common_domains]
...
if __name__ == "__main__":
    emails = "salmosine@gmail.com taofeek@yahoo.com james@ningonaka.com fashieee@kinterjoko.com".split()
